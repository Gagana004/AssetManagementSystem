...
foreach($result as $row)
{
	...
	$sub_array[] = $row['p_qty'];
	$sub_array[] = $status;
	$sub_array[] = '<button type="button" name="update" id="'.$row["p_id"].'" class="btn btn-xs update"><i class="fa fa-edit"></i></button>';
	$sub_array[] = '<button type="button" name="delete" id="'.$row["p_id"].'" class="btn btn-xs delete" data-status="'.$row["p_status"].'"><i class="fa fa-trash"></i></button>';
	$data[] = $sub_array;
}
