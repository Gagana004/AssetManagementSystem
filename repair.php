            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-6">
                        <div class="row">
                            <h3 class="panel-title">Repair List</h3>
                        </div>
                    </div>
                    ...
                    <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <select name="ast_id" id="ast_id" class="form-control" required>
                                    <option value="">Select Asset Code</option> <!-- asset will load using selected item -->
                                </select>
                            </div>
                            <div class="form-group">
...
$(document).ready(function(){
    ...
    //             $('.modal-title').html("<i class='fa fa-pencil-square-o'></i> Edit repair");
    //             $('#dis_id').val(dis_id);
    //             $('#action').val('Edit');
    //             $('#btn_action').val("Edit");
    //         }
