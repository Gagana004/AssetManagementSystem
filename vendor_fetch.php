...
foreach($result as $row)
{
	...
	$sub_array[] = $row['v_tel'];
	$sub_array[] = $status;
	$sub_array[] = '<button type="button" name="update" id="'.$row["v_id"].'" class="btn btn-warning btn-xs update"><i class="fa fa-edit"></i></button>';
	$sub_array[] = '<button type="button" name="delete" id="'.$row["v_id"].'" class="btn btn-danger btn-xs delete" data-status="'.$row["v_status"].'"><i class="fa fa-trash"></i></button>';
	$data[] = $sub_array;
}
